...
const CAPABILITIES: Record<DownloadStatus, DownloadCapabilities> = {
  Queued: { pause: false, resume: false, remove: true, move: false, archive: true },
  Downloading: { pause: true, resume: false, remove: true, move: false, archive: true },
  Paused: { pause: false, resume: true, remove: true, move: false, archive: true },
  ...
  Merging: { pause: false, resume: false, remove: true, move: false, archive: true },
};
